...
import 'Purchase_update_page.dart';

class PurchaseRetrivePage extends StatefulWidget {
  const PurchaseRetrivePage(
      {super.key,
  ...
  final String access;
  @override
  State<PurchaseRetrivePage> createState() => _PurchaseRetrivePageState();
}

class _PurchaseRetrivePageState extends State<PurchaseRetrivePage> {
  ...
  Future<DisposeRetrive?> disposeRetrive() async {
    ...
    final response = await get(
      Uri.http(domain(),
          '/api/pharmacy/${widget.pharmId}/purchase/${widget.disposeId}/'),
