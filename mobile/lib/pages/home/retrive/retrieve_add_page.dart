...
class RetrieveAddPage extends StatefulWidget {
  const RetrieveAddPage({super.key, required this.loginModel});

  final LoginModel loginModel;
  @override
  State<RetrieveAddPage> createState() => _RetrieveAddPageState();
}

class _RetrieveAddPageState extends State<RetrieveAddPage> {
                          ...
                          children: [
                            ...
                            if (tempMed == null)
                              ...
                              const Padding(
                                ...
                                child: Text(
                                    "you don't purchase this medicine medicine"),
                              )
                            else
              ...
              FilledButton(
                  onPressed: () async {
                    ...
                    await http
                        .post(
                            Uri.http(domain(),
                                '/api/pharmacy/${pharmacyId ?? pharmId ?? pharmacies[0].$1}/retrive/'),
                            headers: {
