...
class RetrieveUpdatePage extends StatefulWidget {
  const RetrieveUpdatePage(
      {super.key,
  ...
  final int pharmId;
  @override
  State<RetrieveUpdatePage> createState() => _RetrieveUpdatePageState();
}

class _RetrieveUpdatePageState extends State<RetrieveUpdatePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('update Retrieve'),
      ),
      body: Form(
        key: formState,
        child: Padding(
