...
import 'package:pharmacy/pages/home/dispose/pages/dispose_retrive_page.dart';
import 'package:searchfield/searchfield.dart';

class DisposeListPage extends StatefulWidget {
  const DisposeListPage({super.key, required this.loginModel});

  final LoginModel loginModel;

  @override
  State<DisposeListPage> createState() => _DisposeListPageState();
}

class _DisposeListPageState extends State<DisposeListPage> {
                                            ...
                                            AwesomeDialog(
                                              ...
                                              btnOkOnPress: () async {
                                                final response = await delete(
                                                  Uri.http(domain(),
                                                      '/api/pharmacy/${pharmacyId ?? widget.loginModel.pharmacyId ?? pharmacies[0].$1}/dispose/${snapshot.data![i].id}/'),
                                                  headers: {
                                                    'Authorization':
