...
class DisposeUpdatePage extends StatefulWidget {
  const DisposeUpdatePage(
      {super.key,
  ...
  final int pharmId;
  @override
  State<DisposeUpdatePage> createState() => _DisposeUpdatePageState();
}

class _DisposeUpdatePageState extends State<DisposeUpdatePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('update dispose'),
      ),
      body: Form(
        key: formState,
        child: Padding(
