...
class DisposeAddPage extends StatefulWidget {
  const DisposeAddPage({super.key, required this.loginModel});

  final LoginModel loginModel;
  @override
  State<DisposeAddPage> createState() => _DisposeAddPageState();
}

class _DisposeAddPageState extends State<DisposeAddPage> {
              ...
              FilledButton(
                  onPressed: () async {
                    ...
                    await http
                        .post(
                            Uri.http(domain(),
                                '/api/pharmacy/${pharmacyId ?? pharmId ?? pharmacies[0].$1}/dispose/'),
                            headers: {
