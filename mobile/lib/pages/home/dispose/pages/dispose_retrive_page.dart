...
import 'dispose_update_page.dart';

class DisposeRetrivePage extends StatefulWidget {
  const DisposeRetrivePage(
      {super.key,
  ...
  final String access;
  @override
  State<DisposeRetrivePage> createState() => _DisposeRetrivePageState();
}

class _DisposeRetrivePageState extends State<DisposeRetrivePage> {
  // List<DisposeRetrive> disposeRetrive = [];

  Future<DisposeRetrive?> disposeRetrive() async {
    final response = await get(
      Uri.http(domain(),
          '/api/pharmacy/${widget.pharmId}/dispose/${widget.disposeId}'),
